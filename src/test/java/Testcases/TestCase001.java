...
public class TestCase001 extends BaseClass {
			...
			private void bookAHotel() {
				driver.findElement(By.id("first_name")).sendKeys("phanindra");
				driver.findElement(By.name("last_name")).sendKeys("kurapati");
				driver.findElement(By.xpath(".//textarea[@rows='4']")).sendKeys("xyz");
				driver.findElement(By.xpath(".//input[@id='cc_num']")).sendKeys("8978844792123456");
